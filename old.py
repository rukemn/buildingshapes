...
def query_nominatim(latitude, longitude):
    # Query Nominatim API
    url = f"https://nominatim.openstreetmap.org/reverse?format=jsonv2&lat={latitude}&lon={longitude}&polygon_geojson=1"
...
# Example usage
wkt_point = "POINT (50.72769 7.08988)"  # Example WKT point (latitude, longitude)
try:
